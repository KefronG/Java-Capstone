...
public class SingleChooseAttackScene implements EventHandler<ActionEvent> {
    ...
    public void Attack1ButtonPushed(ActionEvent event) throws IOException {
        ...
        loader.setLocation(getClass().getResource("SingleAttackOutComeScene.fxml"));
        Parent settingsscene = loader.load();
        SingleAttackOutComeScene controller = loader.getController();
