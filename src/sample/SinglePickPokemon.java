...
public class SinglePickPokemon implements EventHandler<ActionEvent> {
    ...
    public void Exit(ActionEvent actionEvent) throws IOException {
        ...
        loader2.setLocation(getClass().getResource("SingleChooseAttackScene.fxml"));
        Parent settingsscene = loader2.load();
        SingleChooseAttackScene controller2 = loader2.getController();
        controller2.Team2(Team9, Team10);
        controller2.setTeam6(Team10);
        controller2.setTeam5(Team9);
        controller2.setP1namePlate(Team9);
        controller2.setP2namePlate(Team10);
        controller2.setHplabel(Team9);
    ...
    public void pickPokemon2( ActionEvent actionEvent) throws IOException {
        ...
        controller2.getTeam1(Team9);
        controller2.getTeam2(Team10);
        controller2.setP1namePlate(Team9);
        controller2.setP2namePlate(Team10);
        controller2.chooseAttack_AI(Team10.get(0));
        controller2.CPU_Attack(Team10, Team9, 0, 0);
        controller2.setHplabel(Team9);
        Scene setwin2 = new Scene(settingsscene);
        Stage window2 = (Stage) ((Node) actionEvent.getSource()).getScene().getWindow();
        settingsscene.setOnMouseClicked(new EventHandler<MouseEvent>() {
